...
export const translations = {
  zh: {
    ...
    modelSelectLabel: "选择模型（alias | model id | VRAM，API 可使用 alias 或 model id）",
    modelNoMatches: "没有匹配的模型",
    allPrebuiltModelsSeparator: "----- all prebuilt models -----",
  ...
  en: {
    ...
    modelSelectLabel: "Select model (alias | model id | VRAM, can use either alias or model id in the API)",
